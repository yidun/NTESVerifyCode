...
//
typedef NS_ENUM(NSInteger, NTESCaptchaType) {
    NTESCaptchaTypeDefault = 1,
    // 滑块拼图
    NTESCaptchaTypeJIGSAW,
    // 文字点选
    NTESCaptchaTypPoint,
    // 短信上行
    NTESCaptchaTypeSms,
    // 智能无感知
    NTESCaptchaTypeIntellisense,
    // 障碍躲避
    NTESCaptchaTypeAvoid,
    // 图标点选
    NTESCaptchaTypeIconPoint,
    // 词组
    NTESCaptchaTypeWordGourp,
    // 图片推理
    NTESCaptchaTypeInference,
    // 语序选词
    NTESCaptchaTypeWordOrder,
    // 空间推理
    NTESCaptchaTypeSpace,
    // 语音识别
    NTESCaptchaTypeVoice
};
